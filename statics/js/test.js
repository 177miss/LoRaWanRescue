...
function loadData() {
    ...
    request.open('GET', '/message_api/', true);
...
var data = [13, 11, 10, 8, 8, 6, 5, 4, 2, 1]
var titlename = ['北京', '上海', '广州', '郑州', '武汉', '南京', '杭州', '东莞', '深圳', '虎门'];
/*var data = new Array();
var titlename = new Array();
for (var i=0; i<message.length; i++)
{
    data[i] = message[i].fields.text_id;
    titlename[i] = message[i].fields.IP;
}*/
option = {  
	grid: {
        left: '0',
